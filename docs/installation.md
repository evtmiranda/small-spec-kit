...
The easiest way to get started is to initialize a new project. Pin a specific release tag for stability (check [Releases](https://github.com/evtmiranda/small-spec-kit/releases) for the latest):
...
```bash
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init .
# or use the --here flag
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init --here
```
...
```bash
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --ai claude
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --ai gemini
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --ai copilot
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --ai codebuddy
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --ai pi
```
...
```bash
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --script sh
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --script ps
```
...
```bash
uvx --from git+https://github.com/evtmiranda/small-spec-kit.git@vX.Y.Z specify init <project_name> --ai claude --ignore-agent-tools
```
...
- `/speckit.plan` - Plan a feature (requirements + tech decisions + tasks)
- `/speckit.execute` - Execute the plan
- `/speckit.refine` - (Optional) Modify the plan before executing
...
git clone https://github.com/evtmiranda/small-spec-kit.git
cd spec-kit
